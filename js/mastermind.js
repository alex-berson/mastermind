...
const enableReset = () => {
    ...
    reset.addEventListener('touchstart', newGame);
    reset.addEventListener('mousedown', newGame);
}
...
const disableReset = () => {
    ...
    reset.removeEventListener('touchstart', newGame);
    reset.removeEventListener('mousedown', newGame);
}
